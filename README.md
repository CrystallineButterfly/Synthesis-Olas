...
- Ampersend
        ...
        ```mermaid
        flowchart TD
    Signals[Autonolas Olas signals] --> Discover[Discover]
    Discover --> Plan[Plan bounded action]
    Plan --> DryRun[Dry run + policy check]
    DryRun --> Guard[PearlMarshalCoordinator]
...
5. Verify receipts, proofs, and notes, then append structured logs.
        ...
        This concept ranks highest because it overlaps OpenServ, ERC-8004 Receipts, Lido Vault Monitor while keeping the
